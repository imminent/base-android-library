 ...
 *
 * <p>To sanitize invalid input implement the {@link com.keepandshare.android.ui.widget.ValidatedEditText.OnFixTextListener} interface and set the
 * listener with {@link #setOnFixTextListener(com.keepandshare.android.ui.widget.ValidatedEditText.OnFixTextListener)}.</p>
 *
...
public class ValidatedAutoCompleteEditText extends AutoCompleteTextView {
     ...
     * @see com.keepandshare.android.ui.widget.ValidatedEditText.Validation
     */
    ...
    private void init(Context context, AttributeSet attributes) {
        if (attributes != null) {
            ...
            setMatcherCriteria(ValidatedEditText.Validation.getCriteria(a.getInt(R.styleable.ValidatedEditText_validation,
                    ValidatedEditText.Validation.NON_EMPTY.ordinal())));
